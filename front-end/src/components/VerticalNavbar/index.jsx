...
/**
 * @component the side Nav component who render html using the context to collect specific data
      ...
      <div className="VerticalNavbar">
         ...
         <ul className="VerticalNavbar_wrapper_items">
            ...
            <li className="VerticalNavbar_items_item">
               <Link to="/" className="link-activities">
                  <svg
                     width="64"
                     height="64"
                     viewBox="0 0 64 64"
            ...
            <li className="VerticalNavbar_wrapper_items_item lastOne">
               <Link to="/" className="link-activities">
                  <svg
                     width="64"
                     height="64"
